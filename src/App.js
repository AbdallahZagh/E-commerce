   ...
   const [isUnsupportedDevice, setIsUnsupportedDevice] = useState(false);
      useEffect(() => {
        const checkDevice = () => {
          ...
          const unsupported =
            isRealIPad || isMobileOrTablet || (isTouchDevice && window.screen.width <= 1280);
      ...
      <div className="flex items-center justify-center h-screen bg-gray-100 p-4">
        <div className="text-center bg-white p-8 rounded-lg shadow-lg max-w-sm mx-auto">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mt-4">Unsupported Device</h1>
          <p className="text-gray-600 mt-2">
          For the best experience, please access this site on a laptop or desktop computer. Mobile phones and tablets are not supported.
          </p>
        </div>
      </div>
    );
